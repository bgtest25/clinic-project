...
restrictive as those in this Agreement. `[List current subprocessors — AWS, Anthropic (via Amazon
Bedrock) — and confirm each has an executed BAA or equivalent flow-down agreement in place before this
section is finalized; see the Subprocessors section of PRIVACY-POLICY.md.]`
