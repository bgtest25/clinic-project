...
// fast-entry convenience for the suggested-codes field. This is NOT a complete or authoritative
// ICD-10-CM code set (the real tabular list has 70,000+ entries and changes yearly) — always
// verify against CMS/an EHR's certified code table before using a code for billing or the chart.
